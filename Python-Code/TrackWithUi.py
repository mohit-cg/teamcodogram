...
blob = Blob.from_string("gs://smartattendance-4fb86.appspot.com")
...
lbl3 = tk.Label(window, text="DESIGN BY TEAM CODOGRAM", width=80, fg="white", bg="black", font=('times', 15, ' bold')) 
